...
public class BrewOilTrigger extends SimpleCriterionTrigger<BrewOilTrigger.TriggerInstance> {
    public static final ResourceLocation ID =
            ResourceLocation.fromNamespaceAndPath(ModSpartanWeaponry.ID, "brew_oil");
    ...
    public record TriggerInstance(
            Optional<ContextAwarePredicate> player, Optional<ResourceLocation> oilEffect)
            implements SimpleCriterionTrigger.SimpleInstance {
        public static final Codec<BrewOilTrigger.TriggerInstance> CODEC =
                        ...
                        instance ->
                                instance.group(
                                                EntityPredicate.ADVANCEMENT_CODEC
                                                        ...
                                                        .forGetter(
                                                                BrewOilTrigger.TriggerInstance
                                                                        ::player),
                                                ResourceLocation.CODEC
                                                        .optionalFieldOf("oil_effect")
                                                        .forGetter(
                                                                BrewOilTrigger.TriggerInstance
                                                                        ::oilEffect))
        ...
        public static Criterion<BrewOilTrigger.TriggerInstance> brewedOil() {
            ...
            return ModCriteriaTriggers.BREW_OIL
                    .get()
                    .createCriterion(
                            new BrewOilTrigger.TriggerInstance(Optional.empty(), Optional.empty()));
        }

        // TODO: Possibly make a advancement for brewing all the oils
        public boolean matches(OilEffect oilEffectIn) {
            if (this.oilEffect.isEmpty()) return true;
