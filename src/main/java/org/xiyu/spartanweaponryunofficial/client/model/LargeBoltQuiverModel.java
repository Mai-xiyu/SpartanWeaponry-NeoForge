...
public class LargeBoltQuiverModel extends QuiverModelBase {
    ...
    public static LayerDefinition createLayer() {
        ...
        part.addOrReplaceChild(
                PART_QUIVER,
                CubeListBuilder.create().texOffs(0, 0).addBox(-3.0f, -3.0f, 3.0f, 6.0f, 5.0f, 4.0f),
        ...
        part.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(26, 0)
                        .addBox(-8.6f, -3.6f, 1.1f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
        ...
        part.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(26, 0)
                        .addBox(-0.4f, -3.6f, 7.1f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, -0.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_2_PART_1,
                CubeListBuilder.create()
                        .texOffs(26, 0)
                        .addBox(-7.4f, -3.6f, 2.4f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, -0.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_2_PART_2,
                CubeListBuilder.create().texOffs(26, 0).addBox(0.9f, -3.6f, 5.9f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, -0.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_3_PART_1,
                CubeListBuilder.create()
                        .texOffs(26, 0)
                        .addBox(-6.8f, -3.6f, 0.6f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, -0.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_3_PART_2,
                CubeListBuilder.create()
                        .texOffs(26, 0)
                        .addBox(-0.9f, -3.6f, 5.3f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, -0.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_4_PART_1,
                CubeListBuilder.create()
                        .texOffs(26, 0)
                        .addBox(-5.5f, -3.6f, 1.8f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, -0.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_4_PART_2,
                CubeListBuilder.create().texOffs(26, 0).addBox(0.3f, -3.6f, 4.0f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, -0.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_5_PART_1,
                CubeListBuilder.create()
                        .texOffs(26, 0)
                        .addBox(-6.1f, -3.6f, 3.6f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, -0.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_5_PART_2,
                CubeListBuilder.create().texOffs(26, 0).addBox(2.1f, -3.6f, 4.6f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, -0.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));
