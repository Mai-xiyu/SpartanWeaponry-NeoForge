...
public class SmallBoltQuiverModel extends QuiverModelBase {
    ...
    public static LayerDefinition createLayer() {
        ...
        part.addOrReplaceChild(
                PART_QUIVER,
                CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, -3.0f, 3.0f, 4.0f, 5.0f, 4.0f),
        ...
        part.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(26, 0)
                        .addBox(-6.1f, -8.0f, 3.3f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, 4.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_1_PART_2,
                CubeListBuilder.create().texOffs(26, 0).addBox(1.8f, -8.0f, 4.6f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, 4.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_2_PART_1,
                CubeListBuilder.create()
                        .texOffs(26, 0)
                        .addBox(-4.7f, -8.0f, 4.7f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, 4.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_2_PART_2,
                CubeListBuilder.create().texOffs(26, 0).addBox(3.2f, -8.0f, 3.2f, 3.0f, 5.0f, 0.0f),
                PartPose.offsetAndRotation(
                        0.0f, 4.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));
        part.addOrReplaceChild(
                PART_ARROW_3_PART_1,
