...
public class CurioRenderer implements ResourceManagerReloadListener {
    ...
    protected static final ResourceLocation smallArrowQuiverTexture =
            ResourceLocation.tryBuild(
                    ModSpartanWeaponry.ID, "textures/model/quiver_arrow_small.png");
    ...
    protected static final ResourceLocation hugeBoltQuiverTexture =
            ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "textures/model/quiver_bolt_huge.png");

    public static final Renderer QUIVER_ARROW_SMALL_RENDERER =
            new Renderer(smallArrowQuiverTexture);
    public static final Renderer QUIVER_ARROW_MEDIUM_RENDERER =
            new Renderer(mediumArrowQuiverTexture);
    public static final Renderer QUIVER_ARROW_LARGE_RENDERER =
            new Renderer(largeArrowQuiverTexture);
    public static final Renderer QUIVER_ARROW_HUGE_RENDERER = new Renderer(hugeArrowQuiverTexture);

    public static final Renderer QUIVER_BOLT_SMALL_RENDERER = new Renderer(smallBoltQuiverTexture);
    public static final Renderer QUIVER_BOLT_MEDIUM_RENDERER =
            new Renderer(mediumBoltQuiverTexture);
    public static final Renderer QUIVER_BOLT_LARGE_RENDERER = new Renderer(largeBoltQuiverTexture);
    public static final Renderer QUIVER_BOLT_HUGE_RENDERER = new Renderer(hugeBoltQuiverTexture);

    private CurioRenderer() {}

    public static void register() {
        CuriosRendererRegistry.register(
                ModItems.SMALL_ARROW_QUIVER.get(), () -> QUIVER_ARROW_SMALL_RENDERER);
        CuriosRendererRegistry.register(
                ModItems.MEDIUM_ARROW_QUIVER.get(), () -> QUIVER_ARROW_MEDIUM_RENDERER);
        CuriosRendererRegistry.register(
                ModItems.LARGE_ARROW_QUIVER.get(), () -> QUIVER_ARROW_LARGE_RENDERER);
        CuriosRendererRegistry.register(
                ModItems.HUGE_ARROW_QUIVER.get(), () -> QUIVER_ARROW_HUGE_RENDERER);

        CuriosRendererRegistry.register(
                ModItems.SMALL_BOLT_QUIVER.get(), () -> QUIVER_BOLT_SMALL_RENDERER);
        CuriosRendererRegistry.register(
                ModItems.MEDIUM_BOLT_QUIVER.get(), () -> QUIVER_BOLT_MEDIUM_RENDERER);
        CuriosRendererRegistry.register(
                ModItems.LARGE_BOLT_QUIVER.get(), () -> QUIVER_BOLT_LARGE_RENDERER);
        CuriosRendererRegistry.register(
                ModItems.HUGE_BOLT_QUIVER.get(), () -> QUIVER_BOLT_HUGE_RENDERER);
    }

    @Override
    public void onResourceManagerReload(@NotNull ResourceManager p_10758_) {
        Minecraft mc = Minecraft.getInstance();
        smallArrowQuiverModel =
                new SmallArrowQuiverModel(
                        mc.getEntityModels().bakeLayer(ModelLayers.SMALL_ARROW_QUIVER));
        mediumArrowQuiverModel =
                new MediumArrowQuiverModel(
                        mc.getEntityModels().bakeLayer(ModelLayers.MEDIUM_ARROW_QUIVER));
        largeArrowQuiverModel =
                new LargeArrowQuiverModel(
                        mc.getEntityModels().bakeLayer(ModelLayers.LARGE_ARROW_QUIVER));
        ...
        smallBoltQuiverModel =
                new SmallBoltQuiverModel(
                        mc.getEntityModels().bakeLayer(ModelLayers.SMALL_BOLT_QUIVER));
        mediumBoltQuiverModel =
                new MediumBoltQuiverModel(
                        mc.getEntityModels().bakeLayer(ModelLayers.MEDIUM_BOLT_QUIVER));
        largeBoltQuiverModel =
                new LargeBoltQuiverModel(
                        mc.getEntityModels().bakeLayer(ModelLayers.LARGE_BOLT_QUIVER));
    ...
    public static class Renderer implements ICurioRenderer {
        ...
        private void renderQuiverModel(
                QuiverModelBase model,
            ...
            model.renderToBuffer(mStack, buffer, packedLight, OverlayTexture.NO_OVERLAY, -1);
            model.renderArrows(
                    arrowsToRender, mStack, buffer, packedLight, OverlayTexture.NO_OVERLAY, -1);
        }
    }
}
