...
public class CurioRenderer implements ResourceManagerReloadListener {
    ...
    public static final Renderer QUIVER_ARROW_SMALL_RENDERER = new Renderer(smallArrowQuiverTexture);
    public static final Renderer QUIVER_ARROW_MEDIUM_RENDERER = new Renderer(mediumArrowQuiverTexture);
    public static final Renderer QUIVER_ARROW_LARGE_RENDERER = new Renderer(largeArrowQuiverTexture);
    ...
    public static final Renderer QUIVER_BOLT_MEDIUM_RENDERER = new Renderer(mediumBoltQuiverTexture);
    ...
    public static class Renderer implements ICurioRenderer {
        ...
        public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext,
            ...
            if (this.model != null)
                this.renderQuiverModel(this.model, this.texture, arrowsToRender, slotContext,
        ...
        private void renderQuiverModel(QuiverModelBase model, ResourceLocation texture, int arrowsToRender, SlotContext slotContext, PoseStack mStack,
            ...
            model.renderArrows(arrowsToRender, mStack, buffer, packedLight, OverlayTexture.NO_OVERLAY, -1);
        }
    }
