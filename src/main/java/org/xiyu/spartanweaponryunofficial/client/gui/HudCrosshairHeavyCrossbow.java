...
{
	public static void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker, ItemStack equippedStack)
	{
...
//            gui.setBlitOffset(-90);
			...
			if(equippedStack != null && !equippedStack.isEmpty() && ItemStackDataHelper.getTag(equippedStack).getBoolean(HeavyCrossbowItem.NBT_CHARGED) && player.getTicksUsingItem() != 0)
			{
