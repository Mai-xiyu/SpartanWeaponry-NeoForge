...
// import net.minecraftforge.client.gui.VanillaGuiLayers; // Disabled - NeoForge-specific
...
/*	public static void registerMeleeWeaponBlockingPropertyOverrides(Item meleeWeapon)
    ...
    public static void registerSkullTextures() {
        ...
        SkullBlockRenderer.SKIN_BY_TYPE.put(ExtendedSkullBlock.Types.HUSK, ResourceLocation.tryBuild("minecraft", "textures/entity/zombie/husk.png"));
        SkullBlockRenderer.SKIN_BY_TYPE.put(ExtendedSkullBlock.Types.STRAY, ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "textures/entity/skull/stray_skull.png"));
        SkullBlockRenderer.SKIN_BY_TYPE.put(ExtendedSkullBlock.Types.DROWNED, ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "textures/entity/skull/drowned_head.png"));
        SkullBlockRenderer.SKIN_BY_TYPE.put(ExtendedSkullBlock.Types.ILLAGER, ResourceLocation.tryBuild("minecraft", "textures/entity/illager/pillager.png"));
        SkullBlockRenderer.SKIN_BY_TYPE.put(ExtendedSkullBlock.Types.WITCH, ResourceLocation.tryBuild("minecraft", "textures/entity/witch.png"));
    }

    // Disabled for Forge 1.21.1 - API differs from NeoForge
    // @SubscribeEvent
    ...
    // Disabled for Forge 1.21.1 - GUI Layer API differs from NeoForge
    // @SubscribeEvent
    // public static void registerHudOverlays(RegisterGuiLayersEvent ev) {
    //     ev.registerAboveAll(ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "load_state"), LOAD_STATE);
    //     ev.registerAboveAll(ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "quiver_ammo"), QUIVER_AMMO);
    //     ev.registerAboveAll(ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "oil_uses"), OIL_USES);
    //     ev.registerAbove(VanillaGuiLayers.CROSSHAIR, ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "crosshair"), NEW_CROSSHAIR);
    // }
