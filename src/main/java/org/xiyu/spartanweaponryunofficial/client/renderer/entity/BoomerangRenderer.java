...
public class BoomerangRenderer extends ThrowingWeaponRenderer<BoomerangEntity> {
    ...
    @Override
    protected void doRenderTransformations(
            BoomerangEntity entity, float partialTicks, PoseStack matrixStack) {
        float rotationInAir =
                entity.getTicksInAir() != 0 && (!entity.isUnderWater())
                        ? (entity.getTicksInAir() + partialTicks) * 40.0f % 360.0f
                        : 0.0f;
        if (entity.getTicksInAir() != 0) entity.setNoGravity(true);
        ...
        matrixStack.mulPose(
                Axis.YP.rotationDegrees(
                        Mth.lerp(partTicks, entity.yRotO, entity.getYRot()) - 90.0f));
        matrixStack.mulPose(
                Axis.ZP.rotationDegrees(
                        Mth.lerp(partTicks, entity.xRotO, entity.getXRot()) - 135.0f));
        ...
        matrixStack.mulPose(
                new Quaternionf()
                        .setAngleAxis(
                                ...
                                rotation.x,
                                rotation.y,
                                rotation.z)); // NOTE: PI = 180 degrees
        ...
        matrixStack.mulPose(
                new Quaternionf()
                        .setAngleAxis(
                                ...
                                rotation.x,
                                rotation.y,
                                rotation.z)); // NOTE: PI / 2 = 90 degrees
