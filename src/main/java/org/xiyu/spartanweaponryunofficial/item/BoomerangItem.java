...
public class BoomerangItem extends ThrowingWeaponItem {
    ...
    public BoomerangItem(
            Item.Properties prop, WeaponMaterial materialIn, WeaponArchetype archetypeIn) {
        super(
                prop.durability(materialIn.getUses()),
                materialIn,
                archetypeIn,
    ...
    public ThrowingWeaponEntity createThrowingWeaponEntity(
        ...
        boomerang.setDistanceToReturn(
                (charge / 5.0d) * (BoomerangEntity.DISTANCE_TO_RETURN - 3.0d)
                        + 3.0d
