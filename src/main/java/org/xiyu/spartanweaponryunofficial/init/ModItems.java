...
import org.xiyu.spartanweaponryunofficial.item.ArrowBaseItem;
import org.xiyu.spartanweaponryunofficial.item.ArrowBaseTippedItem;
import org.xiyu.spartanweaponryunofficial.item.ArrowExplosiveItem;
import org.xiyu.spartanweaponryunofficial.item.BasicItem;
import org.xiyu.spartanweaponryunofficial.item.BoltItem;
import org.xiyu.spartanweaponryunofficial.item.BoltSpectralItem;
import org.xiyu.spartanweaponryunofficial.item.BoltTippedItem;
import org.xiyu.spartanweaponryunofficial.item.DynamiteItem;
import org.xiyu.spartanweaponryunofficial.item.ExtendedSkullItem;
import org.xiyu.spartanweaponryunofficial.item.QuiverArrowItem;
import org.xiyu.spartanweaponryunofficial.item.QuiverBoltItem;
import org.xiyu.spartanweaponryunofficial.item.QuiverSmithingTemplateItem;
...
import org.xiyu.spartanweaponryunofficial.item.WeaponOilItem;
...
/*		public void updateSettingsFromConfig(float baseDamage, float damageMultiplier, double speed, int chargeTicks)
	...
	public static final DeferredHolder<Item, Item> QUIVER_COMPARTMENT = REGISTRY.register("quiver_compartment", () -> new QuiverSmithingTemplateItem());
...
/*	public static final RegistryObject<Item> MEDIUM_QUIVER_UPGRADE_KIT = REGISTRY.register("medium_quiver_upgrade_kit", () -> new BasicItem(new Item.Properties()));
	...
	public static final DeferredHolder<Item, WeaponOilItem> WEAPON_OIL = REGISTRY.register("weapon_oil", () -> new WeaponOilItem());
