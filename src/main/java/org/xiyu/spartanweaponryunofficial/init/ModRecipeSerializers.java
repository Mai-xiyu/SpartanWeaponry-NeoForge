...
public class ModRecipeSerializers {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, TippedProjectileBaseRecipe.Serializer> TIPPED_PROJECTILE_BASE = REGISTRY.register("tipped_projectile", TippedProjectileBaseRecipe.Serializer::new);
    public static final DeferredHolder<RecipeSerializer<?>, QuiverUpgradeRecipe.Serializer> QUIVER_UPGRADE_SMITHING = REGISTRY.register("quiver_upgrade_smithing", QuiverUpgradeRecipe.Serializer::new);
