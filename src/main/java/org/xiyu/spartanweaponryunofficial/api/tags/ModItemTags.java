...
public class ModItemTags {
    ...
    public static final TagKey<Item> COBBLESTONE = ItemTags.create(ResourceLocation.parse("forge:cobblestones"));
    public static final TagKey<Item> LEATHER = ItemTags.create(ResourceLocation.parse("forge:leathers"));
    ...
    public static final TagKey<Item> ALUMINUM_INGOT = ItemTags.create(ResourceLocation.parse("forge:ingots/aluminum"));
...
/*	public static final TagKey<Item> COPPER_NUGGET = ItemTags.create(ResourceLocation.parse("forge:nuggets/copper"));
    ...
    public static final TagKey<Item> RAW_MEAT = ItemTags.create(ResourceLocation.parse("forge:foods/raw_meats"));
