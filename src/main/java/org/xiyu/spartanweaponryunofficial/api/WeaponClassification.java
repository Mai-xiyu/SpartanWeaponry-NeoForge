 ...
 *
 * <p>Classifications are attached automatically to items created through {@link
 * SpartanWeaponryAPI#createWeapon(SpartanWeaponryAPI.WeaponItemType, WeaponMaterial)} and the
 * legacy {@code createXxx(WeaponMaterial)} factories. This metadata is intended for runtime lookup
 * and data-generation helpers; it is not a substitute for real item tag JSON in datapacks.
 */
public record WeaponClassification(
        SpartanWeaponryAPI.WeaponItemType weaponItemType, WeaponMaterial material) {
