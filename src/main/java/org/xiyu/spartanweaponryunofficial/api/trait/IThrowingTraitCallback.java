...
/**
 * Callback class for Throwing Weapon Traits; Implement this in your weapon trait class to implement
...
public interface IThrowingTraitCallback {
    /**
     * Modifies the draw time for the Throwing Weapon. Return the baseCharge value to do nothing
     * with it.
     *
