...
/**
 * Callback class for Melee Weapon Traits; Implement this in your weapon trait class to implement
...
public interface IMeleeTraitCallback extends IGenericTraitCallback {
     ...
     */
    default float modifyDamageDealt(
    ...
    /**
     * Change this to customise damage taken with this weapon equipped with this Weapon Trait when
     * damage is taken
     *
     * @param material The weapon's material
     ...
     */
    default float modifyDamageTaken(
            WeaponMaterial material,
            float baseDamage,
            DamageSource source,
            LivingEntity attacker,
    ...
    /**
     * Use {@linkplain IGenericTraitCallback#onItemUpdate(WeaponMaterial, ItemStack, Level,
     * LivingEntity, int, boolean)} instead! Called once every item tick. Use if item behavior needs
     ...
     * @param attacker The attacking Entity
     * @param projectile The Entity that is directly hitting the target Entity. Will be null if hit
     *     by a melee hit, so please null check!
     */
    ...
    /**
     * Allows Traits to add Attribute Modifiers for any Weapon. Calls {@linkplain
     * #onModifyAttributesMelee(Builder)} by default
     *
    ...
    default void onModifyAttributes(Builder<Attribute, AttributeModifier> builder) {
        this.onModifyAttributesMelee(builder);
    }

    /**
     * Use to edit Melee-only attributes! Otherwise use {@linkplain
     * IGenericTraitCallback#onModifyAttributes(ImmutableMultimap.Builder)} instead!<br>
     * Allows Traits to add Attribute Modifiers for Melee Weapons
     *
     * @param builder The modifier map builder for the item
     */
    default void onModifyAttributesMelee(
            ImmutableMultimap.Builder<Attribute, AttributeModifier> builder) {}

    /**
     * Use {@linkplain IGenericTraitCallback#onCreateItem(WeaponMaterial, ItemStack)} instead!
     * Allows the item to have Enchantments or other NBT data added to the item. This should be
     * reflected in Creative mode too
     *
