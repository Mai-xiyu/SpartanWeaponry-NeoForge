...
public interface IActionTraitCallback {
     ...
     */
    InteractionResult use(ItemStack usingStackIn, Level levelIn, Player playerIn, InteractionHand handIn);
     ...
     */
    default int getUseDuration(ItemStack stackIn, LivingEntity entityIn) {
        return 72000;
    }
     ...
     */
    default ItemUseAnimation getUseAnimation(ItemStack stackIn) {
