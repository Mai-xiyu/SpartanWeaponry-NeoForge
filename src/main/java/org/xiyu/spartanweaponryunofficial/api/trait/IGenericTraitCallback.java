...
/**
 * Callback class suitable for use for most Weapon Traits; Implement this in your weapon trait class
 * to implement custom behavior for your weapon
 *
...
public interface IGenericTraitCallback {
     ...
     */
    default void onModifyAttributes(
