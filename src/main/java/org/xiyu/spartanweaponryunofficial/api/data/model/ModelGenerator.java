...
public class ModelGenerator {
    ...
    public ResourceLocation createHeavyCrossbowModels(Item item, String textureFolderPath) {
        ...
        return this.itemModelProvider.withExistingParent(itemPath, BaseModels.HEAVY_CROSSBOW).texture("layer0", texturePath + textureName + "_standby").
                ...
                override().predicate(ModelOverrides.CHARGED, 1.0f).model(new ExistingModelFile(loaded, this.itemModelProvider.existingFileHelper)).end().
                override().predicate(ModelOverrides.PULLING, 1.0f).predicate(ModelOverrides.CHARGED, 1.0f).model(new ExistingModelFile(firing, this.itemModelProvider.existingFileHelper)).end().
                getLocation();
    }
