 ...
 * Find more info about using the data generator here: <a
 * href=https://mcforge.readthedocs.io/en/1.18.x/datagen/>https://mcforge.readthedocs.io/en/1.18.x/datagen/</a>
 *
...
public class RecipeProviderHelper {
     ...
     * @param additionTag The item Tag which contains specific items to apply to the base item to
     *     upgrade it
     * @param result The resulting upgraded item
     * @param hasItemCriterionName The name of the unlock criteria for this recipe. The recipe will
     *     be "unlocked" when any item in the addition tag is in the player's inventory
     */
    public static void smithingRecipe(
        ...
        SmithingTransformRecipeBuilder.smithing(
                        ...
                        Ingredient.of(base),
                        Ingredient.of(additionTag),
                        RecipeCategory.MISC,
                        result.asItem())
                .unlocks(hasItemCriterionName, hasItem(additionTag))
     ...
     * @param hasItemCriterionName The name of the unlock criteria for this recipe. The recipe will
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeDagger(
            RecipeOutput consumer,
            ItemLike handle,
     ...
     * @param hasItemCriterionName The name of the unlock criteria for this recipe. The recipe will
     *     be "unlocked" when any item in the material tag is in the player's inventory
     * @param requiredModId The name of a required mod ID to be present for the recipe to load.
     *     Leave as "" to ignore this condition
     */
    public static void recipeDagger(
            RecipeOutput consumer,
            ItemLike handle,
        ...
        ConditionalShapedRecipeBuilder recipe =
        ...
        if (!requiredModId.isEmpty()) recipe.condition(new ModLoadedCondition(requiredModId));
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeParryingDagger(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeLongsword(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeKatana(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeSaber(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeRapier(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeGreatsword(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeBattleHammer(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeWarhammer(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeSpear(
            RecipeOutput consumer,
            ItemLike pole,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeHalberd(
            RecipeOutput consumer,
            ItemLike pole,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeLance(
            RecipeOutput consumer,
            ItemLike handle,
            ItemLike pole,
            TagKey<Item> material,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeLongbow(
            RecipeOutput consumer,
            TagKey<Item> stick,
            TagKey<Item> string,
            ItemLike handle,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeHeavyCrossbow(
            RecipeOutput consumer,
            TagKey<Item> planks,
            ItemLike bow,
            ItemLike handle,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeThrowingKnife(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeTomahawk(
            RecipeOutput consumer,
            ItemLike handle,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeJavelin(
            RecipeOutput consumer,
            ItemLike pole,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeBoomerang(
            RecipeOutput consumer,
            TagKey<Item> planks,
            TagKey<Item> material,
            ItemLike result,
            String hasItemCriterionName) {
        recipeBoomerang(
                consumer, Ingredient.of(planks), material, result, hasItemCriterionName, "");
    }
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeBattleaxe(
            RecipeOutput consumer,
            TagKey<Item> stick,
            ItemLike handle,
            TagKey<Item> material,
            ...
            String hasItemCriterionName) {
        recipeBattleaxe(
                consumer, Ingredient.of(stick), handle, material, result, hasItemCriterionName, "");
    }
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeFlangedMace(
            RecipeOutput consumer,
            TagKey<Item> stick,
            ItemLike handle,
            TagKey<Item> material,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeGlaive(
            RecipeOutput consumer,
            ItemLike pole,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeQuarterstaff(
            RecipeOutput consumer,
            ItemLike pole,
            TagKey<Item> material,
            ItemLike result,
     ...
     *     be "unlocked" when any item in the material tag is in the player's inventory
     */
    public static void recipeScythe(
            RecipeOutput consumer,
            ItemLike pole,
            TagKey<Item> material,
            ItemLike result,
