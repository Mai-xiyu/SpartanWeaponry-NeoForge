...
public class TypeDisabledCondition implements ICondition {
    ...
    public static final ResourceLocation NAME = ResourceLocation.tryBuild(SpartanWeaponryAPI.MOD_ID, "type_disabled");
    ...
    @Override
    public boolean test(@NotNull IContext context, com.mojang.serialization.DynamicOps<?> ops) {
