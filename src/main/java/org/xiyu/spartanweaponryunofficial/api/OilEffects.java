...
public class OilEffects {
    public static final ResourceLocation REGISTRY_NAME = ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "oil_effects");
    ...
    public static final RegistryObject<OilEffect> ENDER = REGISTRY.register("ender", () -> new MobOilEffect("ender", OilEffectType.STANDARD, 0x208080, Defaults.OIL_USES_NORMAL, Defaults.OIL_DAMAGE_MODIFIER_NORMAL, OilEffect.USE_ENDER, () -> ModMobEffects.ENDER_DISRPUTION.getHolder().orElseThrow(), 300, 0));
    public static final RegistryObject<OilEffect> ENDER_STRONG = REGISTRY.register("ender_strong", () -> new MobOilEffect("ender", OilEffectType.POTENT, 0x208080, Defaults.OIL_USES_NORMAL, Defaults.OIL_DAMAGE_MODIFIER_STRONG, OilEffect.USE_ENDER, () -> ModMobEffects.ENDER_DISRPUTION.getHolder().orElseThrow(), 600, 0));
    ...
    public static final RegistryObject<OilEffect> POTION = REGISTRY.register("potion", PotionOilEffect::new);
}