...
public class ModSoundDefinitionsProvider extends SoundDefinitionsProvider 
{
	...
	{
		add(ModSounds.THROWN_WEAPON_THROW, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.thrown_weapon_throw").
		...
		add(ModSounds.THROWN_WEAPON_HIT_MOB, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.thrown_weapon_hit_mob").
		...
		add(ModSounds.THROWN_WEAPON_HIT_GROUND, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.thrown_weapon_hit_ground").
		...
		add(ModSounds.THROWING_KNIFE_THROW, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.throwing_knife_throw").
				with(Sound.sound(ResourceLocation.parse("item/trident/throw1"), SoundType.SOUND), 
					Sound.sound(ResourceLocation.parse("item/trident/throw2"), SoundType.SOUND)));
		add(ModSounds.THROWING_KNIFE_HIT_MOB, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.throwing_knife_hit_mob").
				with(Sound.sound(ResourceLocation.parse("item/trident/pierce1"), SoundType.SOUND),
					Sound.sound(ResourceLocation.parse("item/trident/pierce2"), SoundType.SOUND),
					Sound.sound(ResourceLocation.parse("item/trident/pierce3"), SoundType.SOUND)));
		add(ModSounds.THROWING_KNIFE_HIT_GROUND, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.throwing_knife_hit_ground").
				with(Sound.sound(ResourceLocation.parse("item/trident/ground_impact1"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact2"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact3"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact4"), SoundType.SOUND).volume(0.9)));

		add(ModSounds.TOMAHAWK_THROW, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.tomahawk_throw").
				with(Sound.sound(ResourceLocation.parse("item/trident/throw1"), SoundType.SOUND), 
					Sound.sound(ResourceLocation.parse("item/trident/throw2"), SoundType.SOUND)));
		add(ModSounds.TOMAHAWK_HIT_MOB, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.tomahawk_hit_mob").
				with(Sound.sound(ResourceLocation.parse("item/trident/pierce1"), SoundType.SOUND),
					Sound.sound(ResourceLocation.parse("item/trident/pierce2"), SoundType.SOUND),
					Sound.sound(ResourceLocation.parse("item/trident/pierce3"), SoundType.SOUND)));
		add(ModSounds.TOMAHAWK_HIT_GROUND, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.tomahawk_hit_ground").
				with(Sound.sound(ResourceLocation.parse("item/trident/ground_impact1"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact2"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact3"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact4"), SoundType.SOUND).volume(0.9)));

		add(ModSounds.JAVELIN_THROW, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.javelin_throw").
				with(Sound.sound(ResourceLocation.parse("item/trident/throw1"), SoundType.SOUND), 
					Sound.sound(ResourceLocation.parse("item/trident/throw2"), SoundType.SOUND)));
		add(ModSounds.JAVELIN_HIT_MOB, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.javelin_hit_mob").
				with(Sound.sound(ResourceLocation.parse("item/trident/pierce1"), SoundType.SOUND),
					Sound.sound(ResourceLocation.parse("item/trident/pierce2"), SoundType.SOUND),
					Sound.sound(ResourceLocation.parse("item/trident/pierce3"), SoundType.SOUND)));
		add(ModSounds.JAVELIN_HIT_GROUND, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.javelin_hit_ground").
				with(Sound.sound(ResourceLocation.parse("item/trident/ground_impact1"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact2"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact3"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact4"), SoundType.SOUND).volume(0.9)));

		add(ModSounds.BOOMERANG_THROW, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.boomerang_throw").
				with(Sound.sound(ResourceLocation.parse("item/trident/throw1"), SoundType.SOUND), 
					Sound.sound(ResourceLocation.parse("item/trident/throw2"), SoundType.SOUND)));
		add(ModSounds.BOOMERANG_FLY, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.boomerang_fly").
				with(Sound.sound(ResourceLocation.parse("random/bow"), SoundType.SOUND)));
		add(ModSounds.BOOMERANG_HIT_MOB, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.boomerang_hit_mob").
				with(Sound.sound(ResourceLocation.parse("item/trident/pierce1"), SoundType.SOUND),
					Sound.sound(ResourceLocation.parse("item/trident/pierce2"), SoundType.SOUND),
					Sound.sound(ResourceLocation.parse("item/trident/pierce3"), SoundType.SOUND)));
		add(ModSounds.BOOMERANG_BOUNCE, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.boomerang_bounce").
		...
		add(ModSounds.BOOMERANG_HIT_GROUND, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.boomerang_hit_ground").
				with(Sound.sound(ResourceLocation.parse("item/trident/ground_impact1"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact2"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact3"), SoundType.SOUND).volume(0.9), 
					Sound.sound(ResourceLocation.parse("item/trident/ground_impact4"), SoundType.SOUND).volume(0.9)));
		
		add(ModSounds.THROWING_WEAPON_LOYALTY_RETURN, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.throwing_weapon_loyalty_return").
		...
		add(ModSounds.OIL_APPLIED, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.oil_applied").
		...
		add(ModSounds.HAMMER_SLAMS_INTO_GROUND, SoundDefinition.definition().subtitle("subtitle.spartanweaponryunofficial.hammer_slams_into_ground").
