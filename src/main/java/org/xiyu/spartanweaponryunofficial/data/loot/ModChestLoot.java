                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(
                                                LootItem.lootTableItem(ModItems.DAGGERS.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(
                                                                ModItems.PARRYING_DAGGERS.iron
                                                                        .get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(
                                                        ...
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.KATANAS.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.SABERS.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.RAPIERS.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(
                                                        ...
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.STUDDED_CLUB.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.CESTUS.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(
                                        ...
                                        .add(
                                                LootItem.lootTableItem(
                                                        ...
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.SPEARS.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.HALBERDS.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.PIKES.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.LANCES.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(
                                        ...
                                        .add(
                                                LootItem.lootTableItem(
                                                                ModItems.TOMAHAWKS.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.JAVELINS.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(
                                                                ModItems.BOOMERANGS.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(
                                        ...
                                        .add(
                                                LootItem.lootTableItem(
                                                        ...
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.GLAIVES.iron.get())
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(
                                                        ...
                                                        .setWeight(5))
                                        .add(
                                                LootItem.lootTableItem(ModItems.SCYTHES.iron.get())
                                                        .setWeight(5))));
                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1, 2))
                                        .add(
                                                LootItem.lootTableItem(ModItems.BOLT.get())
                                                        .setWeight(5)
                                                        .apply(
                                                                SetItemCountFunction.setCount(
                                                                        UniformGenerator.between(
                                                                                1, 3))))
                                        .add(
                                                LootItem.lootTableItem(ModItems.LONGBOWS.wood.get())
                                                        .setWeight(3))
                                        .add(
                                                LootItem.lootTableItem(ModItems.LONGBOWS.iron.get())
                                                        .setWeight(1))
                                        .add(
                                                LootItem.lootTableItem(
