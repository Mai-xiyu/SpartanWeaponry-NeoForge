...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider registry) {
        final TagKey<Item> WEAPONS = ItemTags.create(ResourceLocation.parse("forge:tools/melee_weapons"));
...
/*		tag(ModItemTags.TIN_NUGGET);
        ...
        final TagKey<Item> HEADS_TAG = ItemTags.create(ResourceLocation.parse("forge:heads"));
