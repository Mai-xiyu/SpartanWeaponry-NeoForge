...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(@NotNull RecipeOutput recipeFunc) {
        ...
        TagKey<Item> string = ItemTags.create(ResourceLocation.parse("forge:strings"));
        TagKey<Item> leather = ItemTags.create(ResourceLocation.parse("forge:leathers"));
        TagKey<Item> gunpowder = ItemTags.create(ResourceLocation.parse("forge:gunpowders"));
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            if (data.getMaterialTag() == netherite) {
                this.smithingRecipe(recipeFunc, ModItems.DAGGERS.diamond.get(), daggers.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.PARRYING_DAGGERS.diamond.get(), parryingDaggers.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.LONGSWORDS.diamond.get(), longswords.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.KATANAS.diamond.get(), katanas.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.SABERS.diamond.get(), sabers.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.RAPIERS.diamond.get(), rapiers.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.GREATSWORDS.diamond.get(), greatswords.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.BATTLE_HAMMERS.diamond.get(), battleHammers.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.WARHAMMERS.diamond.get(), warhammers.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.SPEARS.diamond.get(), spears.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.HALBERDS.diamond.get(), halberds.get(i), data);
                ...
                this.smithingRecipe(recipeFunc, ModItems.LONGBOWS.diamond.get(), longbows.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.HEAVY_CROSSBOWS.diamond.get(), heavyCrossbows.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.THROWING_KNIVES.diamond.get(), throwingKnives.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.TOMAHAWKS.diamond.get(), tomahawks.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.JAVELINS.diamond.get(), javelins.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.BOOMERANGS.diamond.get(), boomerangs.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.BATTLEAXES.diamond.get(), battleaxes.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.FLANGED_MACES.diamond.get(), flangedMaces.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.GLAIVES.diamond.get(), glaives.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.QUARTERSTAVES.diamond.get(), quarterstaves.get(i), data);
                this.smithingRecipe(recipeFunc, ModItems.SCYTHES.diamond.get(), scythes.get(i), data);
            } else {
                ...
                if (data.getMaterialTag() == stone) {
                    ...
                    this.recipeHeavyCrossbow(recipeFunc, planks, heavyCrossbows.get(i), dataLeather);
                } else {
...
//		SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItems.DAGGERS.iron.get()), RecipeCategory.MISC, Ingredient.of(ironNugget).getItems()[0].getItem(), 0.1f, 200).save(recipeFunc, ModSpartanWeaponry.ID + ":" + ForgeRegistries.ITEMS.getKey(Items.IRON_NUGGET).getPath() + "_from_smelting");
        ...
        this.recipeArrow(recipeFunc, copper, stick, feathers, ModItems.COPPER_ARROW.get(), TypeDisabledCondition.COPPER_AMMO);
        ...
        this.recipeArrow(recipeFunc, diamond, stick, feathers, ModItems.DIAMOND_ARROW.get(), TypeDisabledCondition.DIAMOND_AMMO);
        ...
        this.recipeBolt(recipeFunc, iron, ironNugget, feathers, ModItems.BOLT.get(), ModItemTags.HEAVY_CROSSBOWS);
        ...
        this.recipeBolt(recipeFunc, copper, ironNugget, feathers, ModItems.COPPER_BOLT.get(), ModItemTags.HEAVY_CROSSBOWS);
        TippedProjectileRecipeBuilder.tipped(ModItems.TIPPED_COPPER_BOLT.get()).input(ModItems.COPPER_BOLT.get()).save(recipeFunc);
        this.recipeBolt(recipeFunc, diamond, ironNugget, feathers, ModItems.DIAMOND_BOLT.get(), ModItemTags.HEAVY_CROSSBOWS, TypeDisabledCondition.DIAMOND_AMMO);
        ...
        this.quiverSmithingRecipe(recipeFunc, ModItems.QUIVER_COMPARTMENT.get(), ModItems.SMALL_ARROW_QUIVER.get(), ModItems.MEDIUM_QUIVER_BRACE.get(), ModItems.MEDIUM_ARROW_QUIVER.get(), "has_medium_quiver_brace");
        this.quiverSmithingRecipe(recipeFunc, ModItems.QUIVER_COMPARTMENT.get(), ModItems.MEDIUM_ARROW_QUIVER.get(), ModItems.LARGE_QUIVER_BRACE.get(), ModItems.LARGE_ARROW_QUIVER.get(), "has_large_quiver_brace");
        this.quiverSmithingRecipe(recipeFunc, ModItems.QUIVER_COMPARTMENT.get(), ModItems.LARGE_ARROW_QUIVER.get(), ModItems.HUGE_QUIVER_BRACE.get(), ModItems.HUGE_ARROW_QUIVER.get(), "has_huge_quiver_brace");
...
//		quiverSmithingRecipe(recipeFunc, ModItems.LARGE_ARROW_QUIVER.get(), ModItems.HUGE_QUIVER_UPGRADE_KIT.get(), ModItems.HUGE_ARROW_QUIVER.get(), "has_huge_quiver_upgrade_kit");
        ...
        this.quiverSmithingRecipe(recipeFunc, ModItems.QUIVER_COMPARTMENT.get(), ModItems.SMALL_BOLT_QUIVER.get(), ModItems.MEDIUM_QUIVER_BRACE.get(), ModItems.MEDIUM_BOLT_QUIVER.get(), "has_medium_quiver_brace");
        this.quiverSmithingRecipe(recipeFunc, ModItems.QUIVER_COMPARTMENT.get(), ModItems.MEDIUM_BOLT_QUIVER.get(), ModItems.LARGE_QUIVER_BRACE.get(), ModItems.LARGE_BOLT_QUIVER.get(), "has_large_quiver_brace");
        this.quiverSmithingRecipe(recipeFunc, ModItems.QUIVER_COMPARTMENT.get(), ModItems.LARGE_BOLT_QUIVER.get(), ModItems.HUGE_QUIVER_BRACE.get(), ModItems.HUGE_BOLT_QUIVER.get(), "has_huge_quiver_brace");
...
//		ConditionalShapedRecipeBuilder.shaped(ModItems.HUGE_QUIVER_UPGRADE_KIT.get()).define('L', leather).define('#', netherite).pattern("L L").pattern(" # ").unlockedBy("has_netherite_ingot", hasItem(netherite)).condition(new TypeDisabledCondition(Collections.singletonList(TypeDisabledCondition.QUIVER))).save(recipeFunc);
        ...
        // Apply Oil recipe
        recipeFunc.accept(ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "apply_oil"), new ApplyOilRecipe(CraftingBookCategory.MISC), null);
    }
    ...
    private void recipeDagger(RecipeOutput consumer, ItemLike result, RecipeData data) {
        ...
        if (data.isModdedMaterial())
            builder.condition(new NotCondition(new TagEmptyCondition(data.getMaterialTag())));
