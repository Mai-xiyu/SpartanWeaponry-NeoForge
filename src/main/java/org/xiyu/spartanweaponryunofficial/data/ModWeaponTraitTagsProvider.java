...
public class ModWeaponTraitTagsProvider extends IntrinsicHolderTagsProvider<WeaponTrait> 
{
	...
	protected void addTags(HolderLookup.Provider registry) 
	{
		...
		tag(ModWeaponTraitTags.SPEAR).add(WeaponTraits.REACH_2.get());
		tag(ModWeaponTraitTags.HALBERD).add(WeaponTraits.TWO_HANDED_2.get(), WeaponTraits.REACH_1_5.get(), WeaponTraits.SHIELD_BREACH.get());
		tag(ModWeaponTraitTags.PIKE).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.REACH_2_5.get());
		tag(ModWeaponTraitTags.LANCE).add(WeaponTraits.REACH_2.get(), WeaponTraits.DAMAGE_BONUS_RIDING.get(), WeaponTraits.SWEEP_1.get());
		...
		tag(ModWeaponTraitTags.JAVELIN).add(WeaponTraits.DAMAGE_BONUS_THROWN_2.get(), WeaponTraits.REACH_1.get());
		...
		tag(ModWeaponTraitTags.GLAIVE).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.REACH_1_5.get(), WeaponTraits.SWEEP_2.get());
		tag(ModWeaponTraitTags.QUARTERSTAFF).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.SWEEP_2.get(), WeaponTraits.REACH_1.get());
		tag(ModWeaponTraitTags.SCYTHE).add(WeaponTraits.DAMAGE_BONUS_HEAD.get(), WeaponTraits.DECAPITATE.get(), WeaponTraits.REACH_1.get());
