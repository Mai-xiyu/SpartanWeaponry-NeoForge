...
public class ModWeaponTraitTagsProvider extends IntrinsicHolderTagsProvider<WeaponTrait> {
    ...
    public ModWeaponTraitTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registry, ExistingFileHelper existingFileHelper) {
        super(output, WeaponTraits.REGISTRY_KEY, registry,
                (weaponTrait) -> ResourceKey.create(WeaponTraits.REGISTRY_KEY, ResourceLocation.tryBuild(ModSpartanWeaponry.ID, "unknown")),
    ...
    protected void addTags(HolderLookup.@NotNull Provider registry) {
        ...
        this.tag(ModWeaponTraitTags.GLAIVE).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.REACH_1_5.get(), WeaponTraits.SWEEP_2.get());
        this.tag(ModWeaponTraitTags.QUARTERSTAFF).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.SWEEP_2.get(), WeaponTraits.REACH_1.get());
